...
public class FrmCategoria extends javax.swing.JInternalFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(txtNombre.getText().length() == 0 || txtNombre.getText().length() > 20){
            JOptionPane.showMessageDialog(this, "Debes ingresar un nombre sin ser mayor a 20 caracteres.", "Sistema", 
                    JOptionPane.WARNING_MESSAGE);
            txtNombre.requestFocus();
            return;
        }
        if(txtDescripcion.getText().length() > 250){
            JOptionPane.showMessageDialog(this, "La descripcion no debe ser mayor a 250 caracteres");
            txtDescripcion.requestFocus();
        }
        String resp;
        if(this.accion.equals("editar")){
            //editar
             resp = this.CONTROL.actualizar(Integer.parseInt(txtID.getText()),txtNombre.getText(), this.nombresAnt, 
